...
export const packageLayout = [
  ...
  },
  {
    ...
    modules: [],
    controls: ['menu-bar', 'scroll-buttons', 'workspace-density', 'document-scope', 'outline-tree'],
    assets: [
      'dist/controls/scroll-buttons.css',
      'dist/controls/menu-bar.css',
      'dist/controls/outline-tree.css',
    ],
    typeContracts: false,
    standalone: true,
  },
  ...
  },
  {
    ...
    modules: [],
    controls: ['code-editor', 'code-viewport', 'text-search', 'editor-search'],
