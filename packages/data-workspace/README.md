# @wieslawsoltes/xamora-data-workspace

Reusable document-aware components: **DataEditor**. Canonical source lives in `dist/workspaces/`; the package does not import Studio or start an application when imported.

```js
import { DataEditor } from '@wieslawsoltes/xamora-data-workspace';
import '@wieslawsoltes/xamora-data-workspace/data-workspace.css';
```
