# @wieslawsoltes/xamora-workspace-context

Reusable document-aware components: **WorkspaceContext, WorkspaceComponent**. Canonical source lives in `dist/workspaces/`; the package does not import Studio or start an application when imported.
