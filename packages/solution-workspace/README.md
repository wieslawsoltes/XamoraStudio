# @wieslawsoltes/xamora-solution-workspace

Reusable document-aware components: **SolutionWorkspace**. Canonical source lives in `dist/workspaces/`; the package does not import Studio or start an application when imported.

```js
import { SolutionWorkspace } from '@wieslawsoltes/xamora-solution-workspace';
import '@wieslawsoltes/xamora-solution-workspace/solution-workspace.css';
```
