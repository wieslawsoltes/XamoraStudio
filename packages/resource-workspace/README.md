# @wieslawsoltes/xamora-resource-workspace

Reusable document-aware components: **RichProperties, ResourceWorkspace**. Canonical source lives in `dist/workspaces/`; the package does not import Studio or start an application when imported.

```js
import { RichProperties } from '@wieslawsoltes/xamora-resource-workspace';
import '@wieslawsoltes/xamora-resource-workspace/resource-workspace.css';
```
