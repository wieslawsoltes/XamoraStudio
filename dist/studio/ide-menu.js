  ...
  constructor(s) {
    ...
    this.menus = [
      ...
      group('Edit', [
        ...
        cmd('find-code', 'Find in source…', { shortcut: 'Ctrl+F' }),
        cmd('replace-code', 'Replace in source…', { shortcut: 'Ctrl+H' }),
        cmd('find-next-code', 'Find next in source', { shortcut: 'F3' }),
        cmd('find-previous-code', 'Find previous in source', { shortcut: 'Shift+F3' }),
