...
export interface HtmlStatesOptions {
  elements?: Map<string, Element>;
  nodeId?: string;
}
export interface HtmlStateDiagnostic {
...
export function bindHtmlState(
  doc: DesignDocument,
  stateId: string,
  nodeId: string,
): HtmlStateDefinition;
export function setHtmlStateProperties(
  doc: DesignDocument,
  stateId: string,
  values: Record<string, string | null>,
): HtmlStateDefinition;
/** Preserves base declarations; promotes state values above ordinary inline base using explicit !important. */
export function recordHtmlStateProperties(
  doc: DesignDocument,
  stateId: string,
  nodeId: string,
  values: Record<string, string | null>,
...
export interface HtmlStateInteraction {
  ...
  event: HtmlStateEvent;
  action: HtmlStateAction;
}
...
export function bindHtmlStateInteraction(
  doc: DesignDocument,
  stateId: string,
  config: { triggerNodeId: string; event?: HtmlStateEvent; action?: HtmlStateAction },
): HtmlStateInteraction;
