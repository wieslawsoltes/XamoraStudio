...
export interface ExportAdapter {
  serialize(document: DesignDocument): string | ExportResult | Promise<string | ExportResult>;
}
...
export declare function walk(
  root: DesignNode,
  visit: (node: DesignNode, parent: ElementNode | null) => void,
): void;
export declare function parseXaml(
  source: string,
  options?: { name?: string; framework?: Framework },
): DesignDocument;
export declare function serializeXaml(
  document: DesignDocument,
  options?: { framework?: Framework; indent?: string; lineWidth?: number },
): string;
...
export declare function exportHTML(
  document: DesignDocument,
  registry: ToolkitRegistry,
  data?: Record<string, unknown>,
  resourceResolver?: (source: string, node: ElementNode) => ElementNode | null,
): string;
...
export declare class PreviewRenderer {
  ...
  render(
    document: DesignDocument,
    host: HTMLElement,
    options?: { scope?: ElementNode | null; interactive?: boolean; designTime?: boolean },
...
export type FilterOperator =
  'eq' | 'ne' | 'contains' | 'startsWith' | 'gt' | 'gte' | 'lt' | 'lte' | 'isNull' | 'notNull';
...
export declare function parseBinding(
  expression: string,
): { path: string; options: Record<string, string> } | null;
export declare function resolveBinding(
  expression: unknown,
  context: unknown,
  root?: unknown,
): unknown;
...
export interface Interaction {
  ...
  enabled?: boolean;
  condition?: { path: string; operator: FilterOperator; value?: unknown };
}
export interface BindingProvenance {
  contextPath?: string | null;
  recordLocator?: { tableId: string; rowId: string; suffix: string[] };
}
export interface PreviewInput extends BindingProvenance {
  expression?: string;
  value: unknown;
  context?: unknown;
  viewId?: string;
...
export interface PreviewRenderer {
  ...
  onInput?: (change: PreviewInput) => boolean | void;
...
export declare class PrototypeSession extends EventTarget {
  ...
  dispatch(
    ...
    nodeId: string,
    event: PreviewEventName,
    payload?: Partial<PreviewEvent>,
  ): { connections: number; viewId: string };
  describeContext(context: unknown): BindingProvenance;
...
export declare function completeXaml(
  source: string,
  offset: number,
  options: {
    registry: ToolkitRegistry;
...
export declare function writeDefinitions(
  node: ElementNode,
  axis: 'Row' | 'Column',
  definitions: ElementNode[],
): void;
export declare function insertTrack(
  node: ElementNode,
  axis: 'Row' | 'Column',
  index: number,
  value?: string,
...
export declare function planDrop(options: {
  root: ElementNode;
  registry: ToolkitRegistry;
  ids: string[];
  parentId: string;
  ...
  originalRects?: Record<string, { x: number; y: number; width: number; height: number }>;
  grid?: { rows: number[]; columns: number[]; row: number; column: number };
  dock?: string;
}): DropPlan;
export declare function applyDropPlan(document: DesignDocument, plan: DropPlan): void;

export declare function snapBounds(
  ...
  width: number;
  height: number;
  guides: Array<{ axis: 'x' | 'y'; at: number; from: number; to: number }>;
};
...
export interface AnimationScope {
  targetId?: string | null;
  nameScopeId?: string | null;
}
export interface AnimationSample {
  overrides: AnimationValues;
  values: AnimationValues;
  warnings: string[];
}
export declare const ANIMATION_PROPERTIES: readonly string[];
export declare const EASINGS: readonly string[];
export declare const TRANSFORM_PATHS: Readonly<
  Record<'ScaleX' | 'ScaleY' | 'SkewX' | 'SkewY' | 'Angle' | 'X' | 'Y', string>
>;
...
export declare function storyboardTracks(
  doc: DesignDocument,
  story: ElementNode,
  scope?: AnimationScope,
): AnimationTrack[];
export declare function sampleStoryboard(
  doc: DesignDocument,
  story: ElementNode,
  time: number,
  options?: AnimationScope & { baseDocument?: DesignDocument },
): AnimationSample;
export declare function applyAnimationValues(
  doc: DesignDocument,
  values: AnimationValues | AnimationSample,
): DesignDocument;
export declare function resourcesFor(doc: DesignDocument, owner?: ElementNode): ElementNode;
export declare function createStoryboard(
  doc: DesignDocument,
  name?: string,
  duration?: number,
): ElementNode;
export declare function addTrack(
  doc: DesignDocument,
  story: ElementNode,
  target: string | ElementNode,
  property: string,
  explicitType?: AnimationValueType,
): ElementNode;
export declare function setKeyframe(
  track: ElementNode,
  time: number,
  value: PropertyValue,
  options?: {
    interpolation?: 'Linear' | 'Discrete' | 'Spline' | 'Easing';
    mode?: string;
    easing?: string;
    easingMode?: string;
    spline?: string;
...
export declare function readPropertyPath(
  doc: DesignDocument,
  node: ElementNode,
  path: string,
): PropertyValue | undefined;
export declare function writePropertyPath(
  doc: DesignDocument,
  node: ElementNode,
  path: string,
  value: PropertyValue,
): void;
export declare function ensureTransformPath(
  doc: DesignDocument,
  node: ElementNode,
  requested: string,
): string;
export declare function transformGroup(
  node: ElementNode,
  create?: boolean,
  doc?: DesignDocument | null,
): ElementNode | null;
export declare function namedTarget(
  doc: DesignDocument,
  name: string,
  scopeId?: string | null,
): ElementNode | null;
export declare function ensureName(doc: DesignDocument, node: ElementNode, prefix?: string): string;
export interface VisualStateGroupInfo {
  id: string;
  node: ElementNode;
  ownerId: string;
  name: string;
  states: ElementNode[];
  transitions: ElementNode[];
}
export interface VisualStateEntry {
  group: VisualStateGroupInfo;
  state: ElementNode;
  start: number;
  before: AnimationValues;
  transition: ElementNode | null;
  duration: number;
  generated: number;
  explicit: ElementNode | null;
}
export declare function stateGroups(doc: DesignDocument): VisualStateGroupInfo[];
export declare function createStateGroup(
  doc: DesignDocument,
  owner?: ElementNode | string,
  name?: string,
): ElementNode;
export declare function createState(
  group: ElementNode | VisualStateGroupInfo,
  name?: string,
): ElementNode;
export declare function stateStoryboard(state: ElementNode): ElementNode;
export declare function chooseTransition(
  group: ElementNode | VisualStateGroupInfo,
  from: string,
  to: string,
): ElementNode | null;
export declare class VisualStateRuntime {
  ...
  warnings: string[];
  active: Map<string, VisualStateEntry>;
...
export type ResourceResolver = (
  source: string,
  node: ElementNode,
) => DesignDocument | ElementNode | null | undefined;
export declare function resourceEntries(
  node: ElementNode,
  resolveSource?: ResourceResolver,
): ElementNode[];
export declare function findResource(
  doc: DesignDocument,
  node: ElementNode,
  key: string,
  resolveSource?: ResourceResolver,
): ElementNode | undefined;
export declare function scopedResource(
  doc: DesignDocument,
  node: ElementNode,
  key: string,
  resolveSource?: ResourceResolver,
): ElementNode | undefined;
export declare function selectStyles(
  doc: DesignDocument,
  node: ElementNode,
  resolveSource?: ResourceResolver,
): ElementNode[];
export declare function resolveStyle(
  ...
  options?: {
    ...
    transient?: Record<string, unknown> | Map<string, Record<string, unknown>>;
    resolveSource?: ResourceResolver;
  },
): {
  properties: Record<string, PropertyValue>;
  node: ElementNode;
  triggers: ElementNode[];
  active: ElementNode[];
};
export declare function brushNode(
  doc: DesignDocument,
  node: ElementNode,
  property: string,
): ElementNode | undefined;
...
export declare function movePathPoint(
  commands: PathCommand[],
  point: PathPoint | number,
  x: number,
  y: number,
): PathCommand[];
export declare function movePathPoint(
...
export interface PreviewRenderer {
  document: DesignDocument;
  runtimeTemplates: Array<{ ownerId: string; tree: ElementNode }>;
...
export declare function restoreMotion(
  renderer: PreviewRenderer,
  baselines: Map<string, MotionBaseline>,
  options?: { inputs?: boolean },
): void;
export declare function patchMotion(
  renderer: PreviewRenderer,
  doc: DesignDocument,
  overrides: AnimationValues,
  baselines: Map<string, MotionBaseline>,
  options?: { inputs?: Map<string, Record<string, unknown>> },
): DesignDocument;
export declare function motionDiagnostics(
  doc: DesignDocument,
): Array<{ id: string; line: number; severity: 'warning'; message: string }>;
