...
export interface ResourceReference {
  ...
  nodeId: string;
  property: string;
  kind: 'StaticResource' | 'DynamicResource';
}
...
export declare function resourceReferences(
...
export declare function renameResource(
  ...
  key: string,
  resolver?: ResourceResolver,
): { documents: DesignDocument[]; references: number };
export declare function inverseVector(
