...
export interface LegacyDocumentHistoryEntry<T = unknown> {
  label: string;
  document: T;
  patch?: never;
  estimatedBytes?: never;
}
export type DocumentHistoryItem<T = unknown> =
  DocumentHistoryEntry<T> | LegacyDocumentHistoryEntry<T>;
...
export declare function applyHistoryPatch<T>(
  document: T,
  patch: HistoryPatch,
